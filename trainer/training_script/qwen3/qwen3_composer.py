...
from trainer.training_script.qwen3.qwen3_sft import trainer_instance as qwen3_sft_trainer_instance

def qwen3_trainer_composer(
    ...
    if model_args.language_model_class == "qwen3":
        if base_args.use_sfttrainer:
            return qwen3_sft_trainer_instance(
                model = model,
                tokenizer = tokenizer,
